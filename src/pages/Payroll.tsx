...
export function Payroll() {
  ...
  // OPERATIONS departments â€“ purely attendance-based pay
  ...
  const months = [
    ...
    const calculatePayrollForMonth = useCallback((monthKey: string) => {
      ...
      return employees
        ...
        .map((emp) => {
          ...
          // SUM(Jan[@[Basic Salary]:[Other Allowances]]) â€” full breakdown total
          const totalAllowances = basicSalary + housing + transport + otherAllowances;

          // pensionSum = SUM(Basic:Transport) â€” matches Excel: SUM(Jan[@[Basic Salary]:[Transport]])
          ...
          // â”€â”€ PAYE calculation matching Excel formula exactly: â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const handleExportScheduleCSV = () => {
      ...
      if (printType === 'PAYE') {
        ...
        let sn = 1;
        payslipsToPrint.forEach(slip => {
          if (slip.record.nsitf > 0 && slip.record.department.trim().toLowerCase() !== 'adhoc staff') {
      ...
      <div className="flex flex-col gap-8">
        ...
        <Tabs>
          ...
          <TabsContent active={activeTab === 'processing'} className="space-y-6 mt-6">
            {/* â”€â”€ Month selector + Print/Export button â”€â”€ */}
          ...
          {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ PAYE TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          {priv.canViewPayeSchedule && (
          ...
          {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ PENSION TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          {priv.canViewPensionSchedule && (
          ...
          {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ NSITF TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          {priv.canViewNsitfSchedule && (
                    ...
                    <div className="bg-white p-10 mx-auto shadow-sm max-w-5xl rounded-sm print-break" id="print-area-content">
                      <div className="border-b-2 border-indigo-600 pb-4 mb-6" style={{ borderBottom: '2px solid #4f46e5', paddingBottom: '16px', marginBottom: '24px' }}>
                        <div className="flex justify-between items-end" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                          ...
                          <div className="text-right" style={{ textAlign: 'right' }}>
                            <p className="font-semibold text-sm text-slate-600" style={{ fontWeight: 600, fontSize: '14px', color: '#475569', margin: '0' }}>Total Valid Records: {payslipsToPrint.filter(s => printType === 'PAYE' ? s.record.paye > 0 : printType === 'PENSION' ? s.record.pension > 0 : (s.record.nsitf > 0 && s.record.department.trim().toLowerCase() !== 'adhoc staff')).length}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {payslipsToPrint
                            .filter(slip => printType === 'PAYE' ? slip.record.paye > 0 : printType === 'PENSION' ? slip.record.pension > 0 : (slip.record.nsitf > 0 && slip.record.department.trim().toLowerCase() !== 'adhoc staff'))
                            .map((slip, idx) => {
