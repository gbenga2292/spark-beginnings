  ...
  },
  {
    ...
    pages: [
      ...
      { key: 'employees', label: 'Employees', parentKey: 'employees', masterField: 'canView',
        fields: [{ key: 'canView', label: 'View' }, { key: 'canAdd', label: 'Add' }, { key: 'canEdit', label: 'Edit' }, { key: 'canBulkEdit', label: 'Bulk Edit' }, { key: 'canDelete', label: 'Delete', danger: true }, { key: 'canViewSalary', label: 'View Salary', special: true }, { key: 'canViewAnalytics', label: 'Analytics' }, { key: 'canViewOrganogram', label: 'Organogram' }, { key: 'canImport', label: 'Import' }, { key: 'canExport', label: 'Export' }] },
      ...
      { key: 'hmo', label: 'HMO Management', parentKey: 'hmo', masterField: 'canView',
  ...
  },
  {
    ...
    pages: [
      ...
      { key: 'beneficiaries', label: 'Non-Employee Directory', parentKey: 'beneficiaries', masterField: 'canView',
        fields: [{ key: 'canView', label: 'View' }, { key: 'canAdd', label: 'Add' }, { key: 'canEdit', label: 'Edit' }, { key: 'canBulkEdit', label: 'Bulk Edit' }, { key: 'canDelete', label: 'Delete', danger: true }, { key: 'canImport', label: 'Import' }, { key: 'canExport', label: 'Export' }] },
