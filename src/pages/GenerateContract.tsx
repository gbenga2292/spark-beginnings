                ...
                value={contractEmployee} onChange={(e) => {
                  ...
                  if (found) {
                    setContractTempFields({
                      ...
                      compensationText: `You are entitled to a monthly gross compensation of â‚¦${(found.monthlySalaries?.jan || 0).toLocaleString()} only. By your authority, The Company will deduct and remit all statutory deductions and contributions required by law on your behalf.`,
