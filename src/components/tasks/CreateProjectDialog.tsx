...
export function CreateProjectDialog({ 
  ...
  const [subtasks, setSubtasks] = useState<{title: string, assignee: string}[]>([]);
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-gradient-to-r from-primary/5 to-transparent flex-shrink-0 rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground font-medium">Create a new project task</p>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-foreground mb-1.5 uppercase tracking-wide">Start Date</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-foreground mb-1.5 uppercase tracking-wide">Duration (Days)</label>
            ...
            <div className="border border-border bg-muted/20 rounded-xl overflow-hidden mt-4">
               ...
               <div className="p-4 space-y-3">
                 ...
                 <div className="space-y-1.5 max-h-[160px] overflow-y-auto pr-1">
                   ...
                   {subtasks.map((t, i) => (
                     <div key={i} className="flex items-center justify-between text-sm bg-background p-2 rounded-lg border border-border shadow-sm">
                       <div className="flex items-start gap-2 max-w-[85%]">
                         ...
                         <div>
                           <p className="font-medium text-foreground leading-snug">{t.title}</p>
                           {t.assignee && <p className="text-[10px] text-muted-foreground">Assigned: {t.assignee}</p>}
                         </div>
                       </div>
                       <button 
                         type="button"
