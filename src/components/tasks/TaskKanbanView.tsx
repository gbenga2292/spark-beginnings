...
const COLUMNS: { status: SubTaskStatus; label: string; icon: any; color: string; bg: string }[] = [
  { status: "not_started", label: "To Start", icon: Circle, color: "text-muted-foreground", bg: "bg-muted/50" },
...
const MAIN_COLUMNS: { status: string; label: string; icon: any; color: string; bg: string }[] = [
