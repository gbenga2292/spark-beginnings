...
export const DesignPanel: React.FC<DesignPanelProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'layers' | 'levels'>('layers');
  ...
  return (
    <div className="relative h-full flex-shrink-0 select-none z-10" style={{ width: isCollapsed ? 0 : PANEL_WIDTH }}>
      ...
      >
        ...
        <div className="flex border-b border-slate-200 shrink-0">
          <button
            ...
            className={`flex-1 text-xs font-semibold py-2 px-2 text-center transition-colors whitespace-nowrap ${
              activeTab === 'layers'
        ...
        {/* Footer quick actions for Layers */}
      ...
      {/* Collapse / expand toggle — pinned to the right edge of the panel, matching BOM style */}
      <button
