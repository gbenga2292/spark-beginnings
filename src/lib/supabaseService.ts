...
export function dbToEmployee(r: any): Employee {
  return {
    ...
    subjectToPension: r.subject_to_pension ?? r.paye_tax,
...
function employeeToDb(e: Employee) {
  return {
    ...
    subject_to_pension: e.subjectToPension ?? e.payeTax,
...
function commLogToDb(l: CommLog) {
  return {
    ...
    is_internal: l.isInternal ?? false,
...
export const db = {
  ...
  async updateEmployee(id: string, e: Partial<Employee>) {
    ...
    if (e.subjectToPension !== undefined) update.subject_to_pension = e.subjectToPension;
