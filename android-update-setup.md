...
4. Upload your new APK file to this bucket (for example, `dcel-office-suite-1.5.2.apk`).
...
{
  "version": "1.5.2",
  "url": "dcel-office-suite-1.5.2.apk",
...
2. If it detects a newer version (e.g., `1.5.2` is greater than `1.5.1`), it shows the Update button in the app's sidebar.
...
4. The app uses its internal, authenticated connection to Supabase to request a **Signed URL** for `dcel-office-suite-1.5.2.apk`. 
