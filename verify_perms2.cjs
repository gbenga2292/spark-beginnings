...
const checks = [
  ...
  { f: 'src/pages/Payroll.tsx',      k: 'priv.canViewPayeSchedule',msg: 'Payroll - PAYE/Pension/NSITF tabs gated' },
  ...
  { f: 'src/pages/Onboarding.tsx',   k: 'priv.canAdd',    msg: 'Onboarding - Actions gated' },
...
fs.writeFileSync('perm_audit.txt', results.join('\n'), 'utf8');
console.log('Written to perm_audit.txt');
